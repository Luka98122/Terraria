...
def draw_world(window,world, CameraX, CameraY, player): # Draw the world - crta svet po ili boji koji taj blok ima, ili po teksturi. ( Globals.colors_dict i Globals.img_dict)
    counter = 0
    for i in range(GAME_HEIGHT):
        for j in range(GAME_WIDTH): 
    ...
    while True:
        ...
        if startButton.update(mouseState, mousePos) == True:
            ...
            while True: # Main game loop
                ...
                draw_world(window,world, CameraX, CameraY)
